...
biotoosSum is a client-side web application for rendering views over [bio.tools]{https://bio.tools/} content for use on local websites.  For an example see https://biotools-sum.firebaseapp.com/.
