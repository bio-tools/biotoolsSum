      ...
      <Navbar>
        ...
        <Navbar.Collapse>
          <Nav activeKey={this.state.activeMenuItem} onSelect={this.handleSelect}>
            <LinkContainer to={`${collectionAndServicesUrl}/${Type.ALL_SERVICES_ROUTE}`}>
              <NavItem eventKey={0}>All Services</NavItem>
            </LinkContainer>
            <NavDropdown eventKey={1} title='DNA Services' id='dna-nav-dropdown'>
              <LinkContainer to={`${collectionAndServicesUrl}/${Type.DNA_1D_SERVICES_ROUTE}`}>
                <MenuItem eventKey={1.2}>1D DNA Services</MenuItem>
              </LinkContainer>
              <LinkContainer to={`${collectionAndServicesUrl}/${Type.DNA_2D_SERVICES_ROUTE}`}>
                <MenuItem eventKey={1.3}>2D DNA Services</MenuItem>
              </LinkContainer>
              <LinkContainer to={`${collectionAndServicesUrl}/${Type.DNA_3D_SERVICES_ROUTE}`}>
                <MenuItem eventKey={1.4}>3D DNA Services</MenuItem>
              </LinkContainer>
              <LinkContainer to={`${collectionAndServicesUrl}/${Type.DNA_XD_SERVICES_ROUTE}`}>
                <MenuItem eventKey={1.5}>xD DNA Services</MenuItem>
              </LinkContainer>
            </NavDropdown>
            <NavDropdown eventKey={2} title='RNA Services' id='rna-nav-dropdown'>
              <LinkContainer to={`${collectionAndServicesUrl}/${Type.RNA_1D_SERVICES_ROUTE}`}>
                <MenuItem eventKey={2.2}>1D RNA Services</MenuItem>
              </LinkContainer>
              <LinkContainer to={`${collectionAndServicesUrl}/${Type.RNA_2D_SERVICES_ROUTE}`}>
                <MenuItem eventKey={2.3}>2D RNA Services</MenuItem>
              </LinkContainer>
              <LinkContainer to={`${collectionAndServicesUrl}/${Type.RNA_3D_SERVICES_ROUTE}`}>
                <MenuItem eventKey={2.4}>3D RNA Services</MenuItem>
              </LinkContainer>
              <LinkContainer to={`${collectionAndServicesUrl}/${Type.RNA_XD_SERVICES_ROUTE}`}>
                <MenuItem eventKey={2.5}>xD RNA Services</MenuItem>
              </LinkContainer>
            </NavDropdown>
            <NavDropdown eventKey={3} title='Protein Services' id='protein-nav-dropdown'>
              <LinkContainer to={`${collectionAndServicesUrl}/${Type.PROTEIN_1D_SERVICES_ROUTE}`}>
                <MenuItem eventKey={3.2}>1D Protein Services</MenuItem>
              </LinkContainer>
              <LinkContainer to={`${collectionAndServicesUrl}/${Type.PROTEIN_2D_SERVICES_ROUTE}`}>
                <MenuItem eventKey={3.3}>2D Protein Services</MenuItem>
              </LinkContainer>
              <LinkContainer to={`${collectionAndServicesUrl}/${Type.PROTEIN_3D_SERVICES_ROUTE}`}>
                <MenuItem eventKey={3.4}>3D Protein Services</MenuItem>
              </LinkContainer>
              <LinkContainer to={`${collectionAndServicesUrl}/${Type.PROTEIN_XD_SERVICES_ROUTE}`}>
                <MenuItem eventKey={3.5}>xD Protein Services</MenuItem>
              </LinkContainer>
            </NavDropdown>
            <NavDropdown eventKey={4} title='Drug Services' id='drug-nav-dropdown'>
              <LinkContainer to={`${collectionAndServicesUrl}/${Type.DRUG_1D_SERVICES_ROUTE}`}>
                <MenuItem eventKey={4.2}>1D Drug Services</MenuItem>
              </LinkContainer>
              <LinkContainer to={`${collectionAndServicesUrl}/${Type.DRUG_2D_SERVICES_ROUTE}`}>
                <MenuItem eventKey={4.3}>2D Drug Services</MenuItem>
              </LinkContainer>
              <LinkContainer to={`${collectionAndServicesUrl}/${Type.DRUG_3D_SERVICES_ROUTE}`}>
                <MenuItem eventKey={4.4}>3D Drug Services</MenuItem>
              </LinkContainer>
              <LinkContainer to={`${collectionAndServicesUrl}/${Type.DRUG_XD_SERVICES_ROUTE}`}>
